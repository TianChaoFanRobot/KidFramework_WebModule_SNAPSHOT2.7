...
/***
 * TODO TCF AOP动态代理核心助手类
 * TODO TCF 初始化加载AOP切面基类和AOP自定义切面子类之间的映射关系Map
 * TODO TCF 初始化加载代理目标和代理目标的所有代理实例之间的映射关系Map
 * TODO TCF 调用代理工厂根据代理目标和代理目标的所有代理实例批量创建cglib动态代理实例并启动代理实例执行链，按顺序调用每个代理实例的代理方法
 * TODO TCF 将代理目标类型和代理目标的cglib动态代理实例存入Bean组件和Bean组件实例之间的映射关系Map
 * @author 71485
 *
 */
public class AopHelper {

	//TODO TCF 启动AOP动态代理容器
	static
	{
		try
		{
			//TODO TCF 加载AOP切面基类和自定义AOP切面子类之间的映射关系Map
	...
	//TODO TCF 加载使用KidAspect切面注解标注的自定义AOP切面子类
	...
	//TODO TCF 加载AOP切面基类和AOP自定义切面子类之间的映射关系Map
