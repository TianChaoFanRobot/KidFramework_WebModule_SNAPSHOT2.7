...
/***
 * TODO TCF Web框架核心控制器，作用等效于Spring MVC核心控制器DispatcherServlet
 * @author 71485
 *
 */
@WebServlet
			...
			if(handle!=null)
			{
				...
				if(handleController!=null && handleMethod!=null)
				{
					...
					if(parameterNames!=null)
					{
						...
						//TODO TCF 请求作用域中的其他参数，重新存入请求作用域
